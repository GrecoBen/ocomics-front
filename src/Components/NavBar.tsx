 ...
 // file:///home/student/T%C3%A9l%C3%A9chargements/batman-2216148_1280.jpg
  ...
  return (
    <section className="">
      ...
      <nav className="flex justify-between items-center bg-yellow-500 shadow-xl  font-semibold"> 
        ...
        {/*<div className=""> */} 
          ...
          <ul className="hidden flex gap-8 text-sm mx-auto md:flex">
            <li>
          ...
          <div className="">
            <ul className="flex items-center text-sm mx-auto gap-8 ">
              <li>
